...
public class UserDefinedRSSMgtTest extends SSIntegrationTest {

    private static final Log log = LogFactory.getLog(UserDefinedRSSMgtTest.class);
    ...
    public Object[][] attachUsers() {
        return new Object[][]{
                {"UDuser1", "UDdb1", "UDtemp1"},
                {"UDuser2", "UDdb1", "UDtemp1"}
        };
    }
    ...
    public void createRssInstance() throws AxisFault {
        ...
        rssInstanceInfo.setRssInstanceName("UDRSS1");
        ...
        assertEquals(rssInstanceInfo.getRssInstanceName(), "UDRSS1");
    ...
    public void createDB(String dbName) throws AxisFault {
        ...
        database.setRssInstanceName("UDRSS1");
        client.createDatabase(DEFAULT_ENVIRONMENT_NAME, database);
        database = client.getDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", dbName, USER_DEFINED_TYPE);
    ...
    public void createDbUser(String userName) throws AxisFault {
        ...
        databaseUser.setRssInstanceName("UDRSS1");
        client.createDatabaseUser(DEFAULT_ENVIRONMENT_NAME, databaseUser);
        databaseUser = client.getDatabaseUser(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", userName, USER_DEFINED_TYPE);
    ...
    public void attachUserToDB(String user, String db, String temp) throws AxisFault {
        client.attachUserToDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", db, user, temp, USER_DEFINED_TYPE);
        DatabaseUserInfo[] databaseUserInfos = client.getUsersAttachedToDatabase(DEFAULT_ENVIRONMENT_NAME,
                                                                                 "UDRSS1", db, USER_DEFINED_TYPE);
    ...
    public void detachUserFromDB() throws AxisFault {
        client.detachUserFromDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDdb1", "UDuser2", USER_DEFINED_TYPE);
        DatabaseUserInfo[] databaseUserInfos = client.getUsersAttachedToDatabase(DEFAULT_ENVIRONMENT_NAME,
                                                                                 "UDRSS1", "UDdb1", USER_DEFINED_TYPE);
        boolean userExist = false;
        for (DatabaseUserInfo databaseUserInfo : databaseUserInfos) {
    ...
    public void dropAttachedUser() throws AxisFault {
        client.dropDatabaseUser(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDuser1", USER_DEFINED_TYPE);
    }
    ...
    public void dropDatabaseUser() throws AxisFault {
        client.dropDatabaseUser(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDuser2", USER_DEFINED_TYPE);
    ...
    public void createDatasource(String dbName) throws AxisFault {
        DatabaseUserInfo dBInfo[] = client.getUsersAttachedToDatabase(
                DEFAULT_ENVIRONMENT_NAME, "UDRSS1", dbName, USER_DEFINED_TYPE);
        if (dBInfo != null) {
            if (dBInfo.length > 0) {
                UserDatabaseEntryInfo entry = new UserDatabaseEntryInfo();
                entry.setRssInstanceName("UDRSS1");
    ...
    public void createSnapshot() throws AxisFault {
        client.createSnapshot(DEFAULT_ENVIRONMENT_NAME, "UDdb1", USER_DEFINED_TYPE);
    }
    ...
    public void dropDatabase() throws AxisFault {
        client.dropDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDdb1", USER_DEFINED_TYPE);
        boolean isExist = false;
    ...
    public void cleanUp() throws Exception {
        client.dropDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDdb2", USER_DEFINED_TYPE);
        client.dropDatabase(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDdb3", USER_DEFINED_TYPE);
        client.dropDatabaseUser(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDuser1", USER_DEFINED_TYPE);
        client.dropDatabaseUser(DEFAULT_ENVIRONMENT_NAME, "UDRSS1", "UDuser3", USER_DEFINED_TYPE);
        client.dropDatabasePrivilegesTemplate(DEFAULT_ENVIRONMENT_NAME, "UDtemp1");
    }
