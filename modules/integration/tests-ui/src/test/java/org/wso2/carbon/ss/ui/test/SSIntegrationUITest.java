...
*under the License.
*/
package org.wso2.carbon.ss.ui.test;
...
public class SSIntegrationUITest {

    private static final Log log = LogFactory.getLog(SSIntegrationUITest.class);
    protected EnvironmentVariables ssServer;
    protected UserInfo userInfo;

    protected void init() throws Exception {
        int userId = 2;
        userInfo = UserListCsvReader.getUserInfo(userId);
        EnvironmentBuilder builder = new EnvironmentBuilder().ss(userId);
